  ...
  return (
    <div className="relative w-full min-h-screen bg-[var(--color-surface)] p-12 mt-20 flex max-md:flex-col max-md:gap-10 max-md:p-6">
      ...
      <div className="w-1/2 max-md:w-full">
        <div className="text">
          <h1 className="font-grotesk text-9xl leading-none uppercase max-md:text-5xl">
            Marketing
          </h1>
          ...
          <div className="link underline mt-10 flex flex-col max-md:mt-6">
            ...
            <h4 className="mb-3">Rajkot, Gujarat, India</h4>
          </div>
          <div className="link underline mt-10 flex flex-col max-md:mt-6">
            <a className="mb-3" href="#">
              E:
            </a>
            <h4 className="mb-3">dynamicdigitalforge@gmail.com</h4>
          </div>
        </div>
      </div>
    </div>
